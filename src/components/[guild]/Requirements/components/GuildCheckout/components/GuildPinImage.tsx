...
const GuildPinImage = (): JSX.Element => {
  ...
  const guildPinDescription: Record<GuildAction, string> = {
    [GuildAction.JOINED_GUILD]: `This is an onchain proof that you joined ${name} on Kindness.id.`,
    [GuildAction.IS_OWNER]: `This is an onchain proof that you're the owner of ${name} on Kindness.id.`,
    [GuildAction.IS_ADMIN]: `This is an onchain proof that you're an admin of ${name} on Kindness.id.`,
  }
